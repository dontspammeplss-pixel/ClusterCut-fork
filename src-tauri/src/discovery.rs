...
///
/// Wire and app/release versions are independent trackers — they happened
/// to match in 0.3.0/0.3.1, but app 0.3.2 shipped without a wire change
/// (so it advertised wire 0.3.1), and this is the first wire bump since.
///
