...
pub struct AppState {
    ...
    // Network PIN (6-char alphanumeric, for auto-joining). Zeroizing so the
    // secret is wiped from memory on drop/overwrite instead of lingering.
    pub network_pin: Arc<Mutex<zeroize::Zeroizing<String>>>,
    // App Settings
...
impl AppState {
    pub fn new() -> Self {
        Self {
            ...
            network_pin: Arc::new(Mutex::new(zeroize::Zeroizing::new(String::new()))),
